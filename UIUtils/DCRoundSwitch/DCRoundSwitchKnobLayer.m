...
- (void)drawInContext:(CGContextRef)context
{
	...
	CGColorRef knobStartColor = (color1 = [UIColor colorWithWhite:0.82 alpha:1.0]).CGColor;
	CGColorRef knobEndColor = (self.gripped) ? (color2 = [UIColor colorWithWhite:0.894 alpha:1.0]).CGColor : (color2 = [UIColor colorWithWhite:0.996 alpha:1.0]).CGColor;
...
CGGradientRef CreateGradientRefWithColors(CGColorSpaceRef colorSpace, CGColorRef startColor, CGColorRef endColor)
{
	...
	CFArrayRef colorsArray = CFArrayCreate(kCFAllocatorDefault, (const void**)colors, sizeof(colors) / sizeof(CGColorRef), &kCFTypeArrayCallBacks);
