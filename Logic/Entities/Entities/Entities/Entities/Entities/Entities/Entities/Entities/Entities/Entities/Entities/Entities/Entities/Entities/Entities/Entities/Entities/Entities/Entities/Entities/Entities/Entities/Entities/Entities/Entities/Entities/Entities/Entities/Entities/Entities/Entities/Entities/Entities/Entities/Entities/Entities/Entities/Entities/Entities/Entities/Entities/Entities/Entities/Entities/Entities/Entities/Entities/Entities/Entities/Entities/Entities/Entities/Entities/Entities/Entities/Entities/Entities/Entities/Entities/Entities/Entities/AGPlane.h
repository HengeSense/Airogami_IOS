...
@class AGAccount, AGCategory, AGMessage, AGNeoPlane;
...
@property (nonatomic, retain) NSNumber * neoMsgIdOfO;
@property (nonatomic, retain) NSNumber * neoMsgIdOfT;
...
@property (nonatomic, retain) NSNumber * viewedMsgId;
...
@property (nonatomic, retain) AGNeoPlane *neoPlane;
@end
